...
*Manuale riferito alla versione 1.7.22. Le specifiche di dettaglio — formule, formati dei file, motivazioni delle scelte progettuali — sono documentate in SPECIFICA.md all'interno del progetto.*